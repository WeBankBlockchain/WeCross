...
listAccount
listResources
call payment.fabric-mychannel.sacc query a
sendTransaction payment.fabric-mychannel.sacc set a 666
call payment.fabric-mychannel.sacc query a

call payment.bcos-group1.HelloWorldGroup1 get
sendTransaction payment.bcos-group1.HelloWorldGroup1 set Tom
call payment.bcos-group1.HelloWorldGroup1 get
...
prepare_bcos() {
    cd ${ROOT}/bcos/
    echo "127.0.0.1:2 agency1 1,2" >ipconf
    cd -
}
