...
import com.webank.wecross.account.BCOSAccountFactory;
...
public class AccountsConfig {
    private Logger logger = LoggerFactory.getLogger(AccountsConfig.class);
    ...
    @Bean
    public Accounts newAccounts() throws Exception {
