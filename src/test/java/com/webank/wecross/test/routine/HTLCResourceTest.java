...
public class HTLCResourceTest {
    ...
    public void sendTransaction() {
        ...
        Assert.assertEquals(response.getErrorCode().intValue(), ErrorCode.HTLC_ERROR);
    }
    ...
    public void onRemoteTransaction() {
        ...
        //                        transactionRequest, null, new ResourceInfo(), null);
        //
        //
        ...
        //        Assert.assertEquals(response.getErrorCode(), HTLCErrorCode.NO_PERMISSION);
        //
        //        TransactionRequest newTransactionRequest =
        //                new TransactionRequest("unlock", new String[] {"h", "s", "tx", "100"});
        //        TransactionContext<TransactionRequest> newRequest =
        //                new TransactionContext<TransactionRequest>(
        //                        newTransactionRequest, null, new ResourceInfo(), null);
        ...
        //        Assert.assertEquals(newResponse.getErrorCode(), HTLCErrorCode.VERIFY_ERROR);
    }
}
