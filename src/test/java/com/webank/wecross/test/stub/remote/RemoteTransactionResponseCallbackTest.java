...
public class RemoteTransactionResponseCallbackTest {
    @Test
    public void onBCOSTransactionTest() throws Exception {
        String path =
    ...
    @Test
    public void onBCOSGuomiTransactionTest() throws Exception {
        String path =
                RemoteTransactionResponseCallbackTest.class
                        .getClassLoader()
                        .getResource(
                                "data/p2p_response_bcos_gm_transaction_response_with_proof.json")
                        .getPath();
        File file = new File(path);
        String content = FileUtils.readFileToString(file);
