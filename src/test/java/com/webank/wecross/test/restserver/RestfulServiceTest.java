...
public class RestfulServiceTest {
    ...
    public void callTest() throws Exception {
        try {
            ...
            String expectRsp =
                    "{\"version\":\"0.2\",\"result\":0,\"message\":null,\"data\":{\"errorCode\":0,\"errorMessage\":\"call test resource success\",\"hash\":\"010157f4\",";
            Assert.assertTrue(result.contains(expectRsp));
        } catch (Exception e) {
            Assert.assertTrue(e.getMessage(), false);
        }
    ...
    public void sendTransactionTest() throws Exception {
        try {
            ...
            String expectRsp =
                    "{\"version\":\"0.2\",\"result\":0,\"message\":null,\"data\":{\"errorCode\":0,\"errorMessage\":\"sendTransaction test resource success\",\"hash\":\"010157f4\",";
            Assert.assertTrue(result.contains(expectRsp));
        } catch (Exception e) {
            Assert.assertTrue(e.getMessage(), false);
        }
